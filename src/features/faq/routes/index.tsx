...
const Faq = () => {
    ...
    return (
        <Layout>
            <meta name="description" content="Find answers to common questions about Commbitz eSIMs, activation, pricing, and global coverage. Simplify your travel connectivity today " />
            <title>Commbitz FAQs | Answers to Your eSIM Questions</title>
            {loader &&
                <MainLoder />
            }
            <Breadcrumb />
